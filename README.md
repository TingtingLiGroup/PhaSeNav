...
Sae_classify.py
The main entry script of the project, responsible for running the complete classification pipeline
data_prepare.py
Realize data cleaning, screening, format conversion and other preprocessing operations
dictionary.py
Provide general tool functions such as data dictionary construction and encoding conversion
get_fasta.py
Extract or generate biological sequence files in FASTA format
get_features.py
Extract effective feature information from original input data for model training
model_mlp.py
Define the network structure and related parameters of the MLP classification model
train_classify.py
Responsible for model training, parameter optimization and classification experiment verification
dataset/
Store original data and processed dataset files required for the experiment
generation/
Save intermediate generated files, model prediction results and output files
💡 Notes
